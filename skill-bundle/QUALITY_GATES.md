...
| 21 | **Bilingual + language toggle (Rule 17)** | HTML contains `data-lang="ja"` (or equivalent) AND `data-lang="en"` AND a top-right language toggle button (`#lang-toggle` / `.lang-switcher` / similar) | required | implemented top-right |
